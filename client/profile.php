...
// Check if logged in and is a customer
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="profile-info-item">
                                ...
                                <div class="info-value"><?= htmlspecialchars($customer['contact_no']) ?></div>
                            </div>
                            <div class="profile-info-item">
                                <div class="info-label">Address</div>
                                <div class="info-value address-value"><?= htmlspecialchars($customer['address']) ?></div>
                            </div>
                        </div>
                    </div>
                    <div class="text-center mt-4">
                        <p class="text-muted">Contact support if you need to update your profile information.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" form="passwordForm" name="change_password" class="btn btn-primary">Change Password</button>
            </div>
        </div>
    </div>
</div>
