...
<div class="info-section">
    <div class="info-card glass">
        ...
        <div class="info-item"><i class="bi bi-cash-coin"></i> <strong>Rate:</strong> ₱10,000 per delivery</div>
        ...
        <div class="info-item"><i class="bi bi-alarm"></i><strong>Pick-up:</strong> Around Bulacan Only.</div>
    </div>
</div>
