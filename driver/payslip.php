...
// Start session and check if user is logged in as driver
session_start();
...
$driver_query = $con->prepare("SELECT d.driver_id, d.full_name 
                              FROM drivers d 
...
// Get payroll data for this driver
...
");
$payroll_query->bind_param("iss", $driver_id, $start_date, $end_date);
$payroll_query->execute();
$payroll_result = $payroll_query->get_result();

// Get all payroll periods for this driver (for history)
                                ...
                                <div class="card mb-3">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex justify-content-between mb-2">
                                            ...
                                            <span>₱<?= number_format($payroll['truck_maintenance'], 2) ?></span>
                                        </div>
                                        <hr>
                                        <div class="d-flex justify-content-between fw-bold">
                    ...
                    <tbody>
                        <?php while ($history = $history_result->fetch_assoc()): 
                            ...
                            $summary_query = $con->prepare("
                                ...
                                AND pay_period_end = ?
                            ");
                            $summary_query->bind_param("iss", $driver_id, $history['pay_period_start'], $history['pay_period_end']);
