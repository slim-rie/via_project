...
$pdf->Cell(0,10,'Helper Payslip',0,1,'C');
$pdf->Ln(10);

// Employee Information
$pdf->SetFont('Arial','B',12);
$pdf->Cell(40,10,'Helper Name:',0,0);
$pdf->SetFont('Arial','',12);
...
$pdf->Cell(100,10,'Commission (10%)',0,0);
...
// Output PDF
$pdf->Output('I', 'payslip_'.$payroll['full_name'].'_'.date('Y-m-d').'.pdf');
exit();
?>
